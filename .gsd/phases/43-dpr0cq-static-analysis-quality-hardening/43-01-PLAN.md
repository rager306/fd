...
<tasks>
- [x] **T01**: Baseline noise floor captured: 11 issues (1 errorlint, 3 goconst, 5 gosec, 2 unused) перед fixes _(1h)_
...
- [x] **T02**: Fixed all 11 genuine issues: errorlint redis.Nil, gosec G112/G115/G304, revive package-comments + var-naming + early-return, unused consts, test fixture consts _(2h)_
...
- [x] **T03**: Tier 1 linters moved to fail mode (12 linters, 0 issues, CI timeout 15min) + Phase 1 report saved _(1h)_
