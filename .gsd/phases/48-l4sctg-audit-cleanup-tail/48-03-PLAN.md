...
<tasks>
- [x] **T01**: Pinned S03 API polish failures with red tests. _(small)_
...
- [x] **T02**: Fixed validation message clarity and OpenAPI helper fail-loud behavior. _(small)_
...
- [x] **T03**: Ran final M048 gates, wrote issue #7 closure matrix, and validated R039. _(medium)_
