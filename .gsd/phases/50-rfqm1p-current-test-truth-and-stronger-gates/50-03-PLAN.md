...
<tasks>
- [x] **T01**: Выбран рабочий Go mutation runner и подтверждён smoke-запуск. _(45m)_
...
- [x] **T02**: Bounded mutation baseline прошёл на критичных cache, handlers и lifecycle файлах. _(90m)_
...
- [x] **T03**: Mutation baseline policy recorded and R045 validated. _(30m)_
