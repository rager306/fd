...
<tasks>
- [x] **T01**: Собран инвентарь существующих тестов и verification scripts. _(45m)_
...
- [x] **T02**: Запущены текущие test commands и выявлены устаревшие ожидания root integration layer. _(60m)_
...
- [x] **T03**: Исправлен stale root integration test layer под текущий auth/runtime контракт. _(90m)_
...
- [x] **T04**: S01 baseline artifact and requirement evidence recorded. _(30m)_
