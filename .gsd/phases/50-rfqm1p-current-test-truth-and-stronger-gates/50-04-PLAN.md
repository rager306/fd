...
<tasks>
- [x] **T01**: README updated with current test levels, e2e modes, and mutation policy. _(45m)_
...
- [x] **T02**: Final verification and closure artifact recorded for M050 test gates. _(45m)_
