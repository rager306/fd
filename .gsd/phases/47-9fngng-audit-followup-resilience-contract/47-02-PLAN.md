...
<tasks>
- [x] **T01**: Pinned listener fatal-error routing with red tests. _(small)_
...
- [x] **T02**: Replaced listener goroutine os.Exit with controlled shutdown signalling. _(medium)_
...
- [x] **T03**: Recorded S02 evidence and validated R035. _(small)_
