...
<tasks>
- [x] **T01**: Pinned TEI retry and fast-fail gaps with red tests. _(medium)_
...
- [x] **T02**: Added bounded TEI retry and repeated-outage fast-fail behavior. _(medium)_
...
- [x] **T03**: Recorded S03 evidence and validated R033. _(small)_
