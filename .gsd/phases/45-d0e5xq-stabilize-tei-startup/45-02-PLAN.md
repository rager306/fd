...
<tasks>
- [x] **T01**: Inventoried TEI `/data` cache and confirmed USER-bge-m3 Candle files are present. _(45m)_
...
- [x] **T02**: Selected `HF_HUB_OFFLINE=1` as the S03 mitigation candidate. _(30m)_
...
- [x] **T03**: Prepared compose/docs candidate for TEI offline cache startup without restarting runtime. _(45m)_
...
- [x] **T04**: Verified non-destructive S02 state with fd and TEI smoke checks. _(30m)_
