...
<tasks>
- [x] **T01**: Pinned health/metrics diagnostic gaps with red tests. _(medium)_
...
- [x] **T02**: Implemented health last_error/dependency/capacity fields and runtime/cache metrics gauges. _(large)_
...
- [x] **T03**: Recorded S02 evidence, advanced R041, and saved UAT for AN-B/AN-C. _(small)_
