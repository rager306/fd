...
<tasks>
- [x] **T01**: Pinned cache invalidation gaps with red tests. _(medium)_
...
- [x] **T02**: Implemented namespace-safe cache invalidation primitives and HTTP routes. _(medium)_
...
- [x] **T03**: Recorded S01 evidence, advanced R040, and saved UAT for AN-A. _(small)_
