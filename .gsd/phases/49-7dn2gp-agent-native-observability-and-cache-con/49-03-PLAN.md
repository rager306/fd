...
<tasks>
- [x] **T01**: Final static gates passed after lint fixes. _(medium)_
...
- [x] **T02**: Rebuilt the API container and passed live health/metrics/cache invalidation smoke. _(medium)_
...
- [x] **T03**: Wrote issue #8 closure matrix, validated R040-R042, and saved final UAT. _(medium)_
