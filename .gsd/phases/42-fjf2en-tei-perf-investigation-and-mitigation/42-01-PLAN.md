...
<tasks>
- [x] **T01**: Captured direct TEI telemetry snapshot showing batch-size-sensitive queue_time growth for batch 1, 8, and 32. _(1h)_
...
- [x] **T02**: Documented the attempted TEI concurrency profile and the stronger finding: TEI restart/recreate can spend ~48 minutes in backend startup before becoming ready. _(1h)_
...
- [x] **T03**: Wrote the M042 TEI RCA, concluding that TEI queue/startup behavior is the root target and ONNX should be deferred from the current milestone. _(1h)_
