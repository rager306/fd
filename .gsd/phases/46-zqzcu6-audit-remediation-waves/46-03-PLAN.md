...
<tasks>
- [x] **T01**: Added red tests proving batch endpoints still amplify TEI calls per input. _(45m)_
...
- [x] **T02**: Implemented batch cache-miss chunking for `/v1/batch` and `/embeddings/batch`. _(1h 30m)_
...
- [x] **T03**: Verified S03 quality gates and wrote batch backend chunking evidence. _(30m)_
...
- [x] **T04**: Completed runtime UAT and updated R029 for batch backend chunking. _(30m)_
