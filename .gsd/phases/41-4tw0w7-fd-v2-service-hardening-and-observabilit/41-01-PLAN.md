...
<tasks>
- [x] **T01**: Recon текущего fd Go pipeline выполнен в M041 planning phase _(2h)_
...
- [x] **T02**: Error envelope + 17 error codes catalog с table-driven tests _(3h)_
...
- [x] **T03**: Validation middleware (повторное complete после replan) _(4h)_
...
- [x] **T04**: Wire validation в handlers, replace error envelopes, recovery wrapper, 405/404 handlers, encoding_format в /v1/embeddings _(6h)_
...
- [x] **T05**: Live integration verification: 12 probe bugs против running fd container, все pass или в correct envelope _(3h)_
