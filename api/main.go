...
//nolint:gocyclo // main setup logic is naturally complex and better kept together
func main() {
	...
	if err != nil {
		...
		os.Exit(1) //nolint:gocritic // exit is fatal, skipping defers is intended behavior here
	}
