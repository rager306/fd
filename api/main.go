...
func main() {
	...
	// Handlers
	embedHandler := handlers.NewEmbeddingsHandler(teiClient, redisCache, modelID, logger)
	batchHandler := handlers.NewBatchHandler(teiClient, redisCache, modelID, logger)
