...
//nolint:gocyclo // main func is expected to be complex
func main() {
	...
	if err != nil {
		...
		//nolint:gocritic // exitAfterDefer: false positive
		os.Exit(1)
	}
	...
	teiClient.WithObservers(embed.Observers{
		...
		ObserveBatchFillMetrics: func(n int) { metrics.ObserveBatchFillRatio(float64(n) / 32.0) },
	})
