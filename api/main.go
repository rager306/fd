...
//nolint:gocyclo // acceptable main complexity
func main() {
	...
	if err != nil {
		...
		os.Exit(1) //nolint:gocritic // exitAfterDefer: cleanup is expected to be bypassed on fatal start
	}
	...
	teiClient.WithObservers(embed.Observers{
		...
		RecordBatchFillMetric: func(n int) { metrics.ObserveBatchFillRatio(float64(n) / 32.0) },
	})
