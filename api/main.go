...
//nolint:gocyclo // high cyclomatic complexity
func main() {
	...
	if err != nil {
		...
		os.Exit(1) //nolint:gocritic // exit after defer //nolint:gocritic // exit after defer
	}
	...
	if err != nil {
		...
		os.Exit(1) //nolint:gocritic // exit after defer
	}
