...
func setupQueueTestServer(t *testing.T, queueCap int, batchSize int) (*gin.Engine, *queue.ResultStore, chan queue.Item, *queueTestEmbedder, context.CancelFunc) { //nolint:gocritic,unparam // grouping intentional
	t.Helper()
...
func postQueue(t *testing.T, r http.Handler, body string) *httptest.ResponseRecorder { //nolint:unparam // test unused
