...
func setupQueueTestServer(t *testing.T, queueCap, batchSize int) (*gin.Engine, *queue.ResultStore, chan queue.Item, *queueTestEmbedder, context.CancelFunc) { //nolint:unparam // test harness
	t.Helper()
...
func postQueue(t *testing.T, r http.Handler, body string) *httptest.ResponseRecorder { //nolint:unparam // test helper
