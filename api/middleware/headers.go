...
func newRequestID() string {
	...
	// OPTIMIZATION: Use stack-allocated byte array and direct hex.Encode to
	// avoid multiple intermediate string allocations from hex.EncodeToString
	// and string concatenation for request IDs.
	var dst [36]byte
