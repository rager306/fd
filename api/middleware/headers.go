...
func newRequestID() string {
	...
	if _, err := rand.Read(bytes[:]); err != nil {
		// Fallback uses string concatenation with hex formatting to avoid fmt.Sprintf allocations
	...
	// Use stack-allocated buffer to eliminate string concatenations and hex.EncodeToString allocations
	var buf [36]byte
