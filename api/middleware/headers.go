...
func newRequestID() string {
	...
	var buf [36]byte; hex.Encode(buf[0:8], bytes[0:4]); buf[8] = '-'; hex.Encode(buf[9:13], bytes[4:6]); buf[13] = '-'; hex.Encode(buf[14:18], bytes[6:8]); buf[18] = '-'; hex.Encode(buf[19:23], bytes[8:10]); buf[23] = '-'; hex.Encode(buf[24:36], bytes[10:16]); return string(buf[:])
