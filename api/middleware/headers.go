...
func newRequestID() string {
	...
	// Zero-allocation string construction. Avoids hex.EncodeToString which
	// allocates a new string and byte slice, followed by 5 more string slice
	// allocations for the hyphens.
	var dst [36]byte
