...
func newRequestID() string {
	...
	// ⚡ Bolt: Zero-allocation string building for UUID generation.
	// We encode chunks directly into a stack-allocated byte array of the exact size
	// to avoid multiple string allocations and copies via + and hex.EncodeToString.
	var buf [36]byte
