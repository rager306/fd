...
// responseETag generates a hex-encoded sha256 ETag for the given body.
// Performance optimization: writes directly to a stack-allocated buffer to reduce allocations.
