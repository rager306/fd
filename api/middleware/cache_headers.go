...
func responseETag(body []byte) string {
	...
	// Assemble the ETag string directly into a stack-allocated byte array
	// to avoid multiple heap allocations from string concatenation and hex.EncodeToString.
	var dst [66]byte
	dst[0] = '"'
