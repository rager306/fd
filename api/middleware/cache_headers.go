...
func responseETag(body []byte) string {
	...
	// Optimize: eliminate intermediate slice allocations and string concatenation
	// overhead by assembling the entire output within a stack-allocated byte array.
	var dst [66]byte
	dst[0] = '"'
