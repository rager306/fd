...
// responseETag computes a strong ETag for the response body.
// Optimized to reduce heap allocations by directly assembling
// the quoted hex string into a stack-allocated array.
