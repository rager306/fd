...
// responseETag computes a quoted ETag string efficiently.
// Performance optimization: Avoids multiple heap allocations by assembling the quoted
// hex string directly into a single stack-allocated byte array before casting to string.
