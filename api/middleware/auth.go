...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Pre-compute the hash of the expected API key to avoid re-hashing on every request
	// and to ensure equal lengths for ConstantTimeCompare to prevent timing attacks.
