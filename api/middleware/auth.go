...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Securely hash the expected API key once at initialization to prevent timing attacks
	// based on length differences, and to avoid re-hashing on every request.
