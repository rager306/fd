...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Pre-compute the hash of the expected API key to avoid overhead on every request.
	// Securely comparing secrets of variable lengths requires hashing both inputs first.
	...
	return func(c *gin.Context) {
		...
		// Hash the provided token before comparing
