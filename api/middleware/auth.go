...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// 🛡️ Hash the API key once during initialization to securely compare
	// secrets of potentially variable lengths without leaking the length
	// via a timing side-channel (subtle.ConstantTimeCompare returns 0
