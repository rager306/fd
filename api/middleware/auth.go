...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// 🛡️ Sentinel: Pre-compute hash of static API key to avoid re-computing on every request
	// and to ensure fixed-length comparison, preventing length-based timing attacks.
