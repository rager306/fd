...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	...
	// This prevents length-based timing attacks during subtle.ConstantTimeCompare
	// by ensuring both slices are fixed-length (32 bytes for SHA-256).
	...
	return func(c *gin.Context) {
		...
		// 🛡️ Sentinel: Hash the incoming token before comparison to guarantee
		// fixed-length slices and prevent timing leaks.
