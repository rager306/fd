...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Hash expected secret once during initialization to avoid re-computing overhead on every request
	...
	return func(c *gin.Context) {
		...
		// Hash both tokens to ensure a fixed length, preventing length-based timing leaks in ConstantTimeCompare
