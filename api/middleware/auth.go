...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Sentinel: Hash expected API key once to prevent length-based timing attacks
	// while also avoiding redundant processing on every request.
	...
	return func(c *gin.Context) {
		...
		// Sentinel: Hash the provided token to ensure both inputs are of equal length
