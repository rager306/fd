...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Hash both the token and the apiKey to ensure equal length before passing to ConstantTimeCompare.
		// This prevents length-based timing attacks where ConstantTimeCompare returns early if lengths differ.
