...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Pre-compute the hash of the expected API key to avoid re-computation overhead.
	...
	return func(c *gin.Context) {
		...
		// Hash the provided token before comparison to prevent length-based timing attacks.
