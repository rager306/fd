...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Hash the expected API key once during initialization to prevent length-based timing leaks
	...
	return func(c *gin.Context) {
		...
		// Hash incoming token before comparison to ensure fixed-length slices
