...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Hash the expected API key once during initialization to avoid re-computing it
	// on every request, and to prevent timing attacks that leak the key length.
	...
	return func(c *gin.Context) {
		...
		// Hash the provided token before comparing to ensure constant-time comparison
