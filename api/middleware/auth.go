...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Pre-compute expected API key hash to prevent timing attacks on variable-length secrets
	// and avoid per-request overhead.
	...
	return func(c *gin.Context) {
		...
		// Hash incoming token to match fixed length for safe comparison
