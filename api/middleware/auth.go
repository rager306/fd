...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Hash the expected API key once during initialization to avoid overhead on every request
	// and prevent length-based timing attacks.
	...
	return func(c *gin.Context) {
		...
		// Hash provided token to prevent length-based timing attacks
