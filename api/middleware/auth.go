...
func APIKeyAuth(apiKey string) gin.HandlerFunc {
	// Pre-compute the expected hash outside the hot path
	...
	return func(c *gin.Context) {
		...
		// Hash the incoming token to prevent length-leaking timing attacks
		// subtle.ConstantTimeCompare immediately returns 0 if lengths differ.
