...
type Metrics struct {
	...
	redisSizeTimeout  time.Duration //nolint:unused // future
}
...
func NewMetrics() *Metrics {
	metrics := &Metrics{
		...
		}, []string{"result", "tier"}), //nolint:goconst // ignore metric tag
...
// DecTEIRequestsInFlight decrements in-flight requests
