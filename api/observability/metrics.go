...
func NewMetrics() *Metrics {
	metrics := &Metrics{
		...
		}, []string{"result", "tier"}), //nolint:goconst // prom metrics
...
// DecTEIRequestsInFlight manages a gauge for a gauge for
...
// DecTEIRequestsInFlight manage a gauge for concurrent TEI calls.
