...
func NewMetrics() *Metrics {
	metrics := &Metrics{
		...
		}, []string{"result", "tier"}), //nolint:goconst // standard metrics label
		...
		}, []string{"tier"}), //nolint:goconst // standard metrics label
...
// DecTEIRequestsInFlight decrements the concurrent TEI calls gauge.
