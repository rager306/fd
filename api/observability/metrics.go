...
type Metrics struct {
	...
	redisSizeTimeout  time.Duration //nolint:unused // planned for future use
}
...
func NewMetrics() *Metrics {
	metrics := &Metrics{
		...
		}, []string{"result", "tier"}), //nolint:goconst // standard string value
...
// DecTEIRequestsInFlight decrements the gauge measuring TEI requests in flight.
