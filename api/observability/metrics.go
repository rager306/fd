...
func NewMetrics() *Metrics {
	metrics := &Metrics{
		...
		}, []string{"result", "tier"}), //nolint:goconst // literal string is intentional
...
func (m *Metrics) DecTEIRequestsInFlight() { m.teiRequestsInFlight.Dec() } //nolint:revive // simple decrementor
