...
func NewMetrics() *Metrics {
	metrics := &Metrics{
		...
		}, []string{"result", "tier"}), //nolint:goconst // tier label is standard here
		...
		}, []string{"tier"}), //nolint:goconst // tier label is standard here
...
// DecTEIRequestsInFlight decrements the gauge tracking the number of
// concurrent TEI calls. Safe to call from multiple goroutines.
