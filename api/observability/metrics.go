...
type Metrics struct {
	...
	redisSizeTimeout  time.Duration //nolint:unused // intentionally unused for now
}
...
func NewMetrics() *Metrics {
	metrics := &Metrics{
		...
		}, []string{"result", "tier"}), //nolint:goconst // label key
		...
		}, []string{"tier"}), //nolint:goconst // label key
...
// DecTEIRequestsInFlight decrements the in-flight TEI requests counter.
