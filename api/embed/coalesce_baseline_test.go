...
func runCorpusBurst(t *testing.T, e Embedder, texts []string, concurrency int) (calls, totalTexts int, durations []time.Duration) { //nolint:unparam // calls used in output
	t.Helper()
	...
	rng := rand.New(rand.NewSource(42)) //nolint:gosec // non-crypto
